...
libraryDependencies ++= Seq(
  "org.neo4j" % "neo4j-lucene-index" % "1.8.M07" exclude("org.neo4j", "neo4j-udc"),
  "org.neo4j" % "neo4j-rest-graphdb" % "1.8.M07" exclude("org.neo4j", "neo4j-udc"),
  "org.neo4j" % "neo4j-cypher" % "1.8.M07" exclude("org.neo4j", "neo4j-udc"),
